            ...
            <div class="list-block" style="margin-top: 20px;margin-bottom: 60px">
                <ul>
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-title label server_title">清理内容</div>
                                <div class="item-input">
                                    <div class="server_more_box" v-for="item in list">
                                        <p>{{item.type}}-{{item.sub.name}}-{{item.num}}件</p>
                                    ...
                                    <div class="jiadian_more text_placeholder" style="">
                                        <a class="open-popup" data-popup=".popup-about" style="color: #5e93f9">
                                            添加清理内容<img src="../img/user/add_place.png" height="13" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li v-for="(items,x) in list">
                                    ...
                                    <div class="item-content" v-for="(item,y) in items.secondList">
                                        <div class="item-inner chose_detail_item-inner"  style="padding: 15px 5px">
                                            ...
                                            <div class="item-after shoe_chose_after"><span :id="item.id">0</span>件</div>
...
<script>
    ...
    var uncle = new Vue({
        ...
        data: {
            ...
            list: [{auntid:1}], canBookAuntList: [], ids:[],
            longitude: getItem('user_lng'), latitude: getItem('user_lat'), thirdids: ''
        },
        emulateJSON: true,
        mounted: function() {
        },
    ...
    var service = new Vue({
        ...
        data: {
            ...
            userInfo: [], longitude: lng, latitude: lat,
                ...
                this.$http.get(createUrl(this.serveUrl, {}, true))
                        .then(function(response) {
                            if (response.data.c == 1) {
                                var jsonData = JSON.parse(response.data.r);
//                                console.log(jsonData)
                                var server=jsonData.firstList[0].secondList[0];
