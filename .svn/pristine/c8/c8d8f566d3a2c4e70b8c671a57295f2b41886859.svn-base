    ...
    <div class="page page-current" id="user_home">
        <div class="content" id="service" style="background-color: #ffffff">
            ...
            <div class="list-block" style="margin-top: 20px;">
                ...
                <div class="pay_btn">
                    <a class="button back_btn pay_btn"  v-on:click="sendData" v-cloak>立即预约</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    setItem('server_url','../auth/go?uri=/wechat/serves/jiachang');
...
//                                console.log(jsonData)
                            var server=jsonData.firstList[2].secondList[1];
