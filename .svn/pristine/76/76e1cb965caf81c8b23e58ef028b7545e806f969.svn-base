...
<div class="row">
		...
		<div class="col-xs-12" >
	        <div class="form-group">
				...
				<div class="col-sm-2">
					<select data-rel="tooltip" type="text" class="col-sm-10 searchKey" id="type" name="type" title="轮播图跳转类型" data-placement="bottom" onchange="changeType()" >
		...
		<div class="col-xs-12" >
			...
			<input class="col-sm-10 searchKey" id="contentid" name="contentid" value=" " class="searchKey" title="内容" data-placement="bottom"/>
				</div>
			</div>
		</div>
