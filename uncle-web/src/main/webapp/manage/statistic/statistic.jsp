	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="col-xs-3">
				...
				<div class="col-xs-12 statistic" style="background-color: rgb(160,214,190);margin-top: 20px;">
			...
			<div class="col-xs-3">
				...
				<div class="col-xs-12 statistic" style="background-color: rgb(160,194,214); border-top: 1px solid rgb(138,172,199);margin-top: 20px;">
			...
			<div class="col-xs-3">
				...
				<div class="col-xs-12 statistic" style="background-color: rgb(185,84,67);margin-top: 20px;">
