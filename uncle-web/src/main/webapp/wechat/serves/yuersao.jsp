        ...
        <div class="content" style="background-color: white">
            <div class="pay_confirm">
                ...
                <div class="confirm_item">
                    ...
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 0">{{list.bookOrderInfo.expect_time}}月</div>
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 1">{{list.bookOrderInfo.expect_time}}天</div>
                </div>
...
<script>
	setItem('server_url','../auth/go?uri=/wechat/serves/yuersao');
            ...
            getServeInfo:function () {
                this.$http.get(createUrl(this.serveUrl, {}, true))
                    .then(function(response) {
                        if (response.data.c == 1) {
                            var jsonData = JSON.parse(response.data.r);
                            var server=jsonData.firstList[4].secondList[2];
