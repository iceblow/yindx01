            ...
            <div class="list-block" style="margin-top: 20px;">
                <ul>
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-title label server_title">酒席桌数</div>
                                <div class="item-input">
                                    <input type="text btn_input" v-model="thing_count" placeholder="请输入桌数">
                                </div>
                            </div>
                        </div>
                    </li>
                    <li v-for="items in e_data">
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-title label server_title">{{items.name}}</div>
                                <div class="item-input">
                                    <a class="server_btn button" v-for="item in items.secondList" v-on:click="getId(item.id,$event)">{{item.name}}</a>
                                    <input type="text" placeholder="其他情况在这里描述">
                                </div>
                            </div>
                        </div>
                    </li>
        ...
        <div class="content" style="background-color: white">
            <div class="pay_confirm">
                ...
                <div class="confirm_item">
                    ...
                    <div class="confirm_text">{{list.server_aunt}}位</div>
                </div>
                <div class="confirm_item">
...
//                                console.log(jsonData)
                                var server=jsonData.firstList[1].secondList[0];
    ...
    var conInfo=new Vue({
        ...
        data: {
            list:{
                server_name:'',
                server_price:'',
                server_aunt:service.uncle_list.length,
                server_time: '',
