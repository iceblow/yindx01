            ...
            <div class="list-block" style="margin-top: 20px;">
                <ul>
                    ...
                    <li v-if="work_type == 1">
                        <div class="item-content">
                            <div class="item-inner" style="padding: 20px 0">
                                <div class="item-title label server_title">试工时长</div>
                                <div class="item-input" style="position: relative;margin-left: 20px">
                                    <span class="xiyi_time test_num">1</span>小时
                                    <img class="add_num_img add_time" v-on:click="add_time('test_num',1)" src="../img/serve/up_logo.png" />
                                    <img class="reduce_num_img reduce_time" v-on:click="add_time('test_num',-1)" src="../img/serve/down_logo.png" />
                                </div>
                            </div>
                        </div>
                    </li>
        ...
        <div class="content" style="background-color: white">
            <div class="pay_confirm">
                ...
                <div class="confirm_item">
                    ...
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 0">{{list.bookOrderInfo.day_time}}天</div>
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 1">{{list.bookOrderInfo.day_time}}小时</div>
                </div>
                <div class="confirm_item" v-if="list.bookOrderInfo.order_type == 0">
                    <div class="confirm_title">每天工时</div>
...
<script>
    setItem('server_url','../auth/go?uri=/wechat/serves/peihu');
            ...
            getServeInfo:function () {
                this.$http.get(createUrl(this.serveUrl, {}, true))
                    .then(function(response) {
                        if (response.data.c == 1) {
                            var jsonData = JSON.parse(response.data.r);
                            var server=jsonData.firstList[4].secondList[1];
