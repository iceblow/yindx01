...
<!--                                     </div> -->
<!--                                     <div class="uncle_more text_placeholder" v-if="uncle_list.length== 0" data-popup=".popup-uncle">可多选</div> -->
<!--                                 </div> -->
<!--                             </div> -->
<!--                         </div> -->
<!--                     </li> -->
...
<script>
    setItem('server_url','../auth/go?uri=/wechat/serves/kaisuo');
            ...
            getServeInfo:function () {
                this.$http.get(createUrl(this.serveUrl, {}, true))
                    .then(function(response) {
                        if (response.data.c == 1) {
                            var jsonData = JSON.parse(response.data.r);
                            var server=jsonData.firstList[3].secondList[0];
