            ...
            <div class="list-block" style="margin-top: 20px;">
                <ul>
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-title label server_title">服务方式</div>
                                <div class="item-input">
                                    <a class="server_btn button btn_active" v-on:click="getType(0,$event)">正式单</a>
                                    <a class="server_btn button" v-on:click="getType(1,$event)">试工</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li v-if="work_type == 1">
                        <div class="item-content">
                            <div class="item-inner" style="padding: 20px 0">
                                <div class="item-title label server_title">试工天数</div>
                                <div class="item-input" style="position: relative;margin-left: 20px">
                                    <span class="xiyi_time">1</span>天
...
<!--                             <div class="item-inner"> -->
<!--                                 <div class="item-title label server_title">服务人员</div> -->
...
<!--                                     </div> -->
<!--                                     <div class="uncle_more text_placeholder" v-if="uncle_list.length== 0">请选择公司</div> -->
<!--                                 </div> -->
<!--                             </div> -->
<!--                         </div> -->
<!--                     </li> -->
        ...
        <div class="content" style="background-color: white">
            <div class="pay_confirm">
                ...
                <div class="confirm_item">
                    ...
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 0">{{list.bookOrderInfo.expect_time}}天</div>
                    <div class="confirm_text" v-if="list.bookOrderInfo.order_type == 1">{{list.bookOrderInfo.expect_time}}小时</div>
                </div>
...
<script>
    setItem('server_url','../auth/go?uri=/wechat/serves/jujia');
...
//            this.getThird();
        ...
        methods: {
            getServeInfo:function () {
                this.$http.get(createUrl(this.serveUrl, {}, true))
                        .then(function(response) {
                            if (response.data.c == 1) {
                                var jsonData = JSON.parse(response.data.r);
                                var server=jsonData.firstList[4].secondList[4];
            ...
            canBookAuntList: function () {
                this.$http.get(createUrl(this.apiCanBookAuntListUrl, {longitude: lng, latitude: lat, serverid:this.server_id, thirdids:''}, false))
                        .then(function(response) {
                            if (response.data.c == 1) {
                                var jsonData = JSON.parse(response.data.r);
