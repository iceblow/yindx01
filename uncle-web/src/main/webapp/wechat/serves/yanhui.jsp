                        ...
                        <div class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input type="text" value="宴会帮工" disabled>
...
//                                console.log(jsonData)
                                ...
                                con_info.server_name = server.name;
                                this.server_price=server.deposit_price;
                                con_info.server_price = server.deposit_price;
                                this.server_id=server.id;
                                uncle.getCustomers();
                                this.canBookAuntList();
                                this.getThird();
//                                console.log(jsonData.firstList[0].secondList[0])
                            } else {
                                $.toast(response.data.m);
                            }
                        })
